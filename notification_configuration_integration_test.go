...
func TestNotificationConfigurationList_forProjects(t *testing.T) {
	t.Parallel()
	skipUnlessBeta(t)
	client := testClient(t)
	ctx := context.Background()
	...
	ncTest1, ncTestCleanup1 := createProjectNotificationConfiguration(t, client, pTest, nil)
	t.Cleanup(ncTestCleanup1)
	ncTest2, ncTestCleanup2 := createProjectNotificationConfiguration(t, client, pTest, nil)
	t.Cleanup(ncTestCleanup2)
	...
	t.Run("without a valid project", func(t *testing.T) {
		ncl, err := client.NotificationConfigurations.List(
			ctx,
			badIdentifier,
			&NotificationConfigurationListOptions{
...
func TestNotificationConfigurationCreate_forProjects(t *testing.T) {
	t.Parallel()
	skipUnlessBeta(t)
	client := testClient(t)
	ctx := context.Background()
	...
	t.Run("with all required values", func(t *testing.T) {
		options := NotificationConfigurationCreateOptions{
			...
			URL:                String("http://example.com"),
			Triggers:           []NotificationTriggerType{NotificationTriggerCreated},
			SubscribableChoice: &NotificationConfigurationSubscribableChoice{Project: pTest},
		}
		nc, err := client.NotificationConfigurations.Create(ctx, pTest.ID, options)
	...
	t.Run("with email users when destination type is email", func(t *testing.T) {
		...
		_, err := client.NotificationConfigurations.Create(ctx, pTest.ID, options)
		require.NoError(t, err)
	})
...
func TestNotificationConfigurationRead_forProjects(t *testing.T) {
	t.Parallel()
	skipUnlessBeta(t)
	client := testClient(t)
	ctx := context.Background()
	...
	ncTest, ncTestCleanup := createProjectNotificationConfiguration(t, client, pTest, nil)
	t.Cleanup(ncTestCleanup)
...
func TestNotificationConfigurationUpdate_forProjects(t *testing.T) {
	t.Parallel()
	skipUnlessBeta(t)
	client := testClient(t)
	ctx := context.Background()
	...
	emailOptions := &NotificationConfigurationCreateOptions{
		DestinationType:    NotificationDestination(NotificationDestinationTypeEmail),
		Enabled:            Bool(false),
		Name:               String(randomString(t)),
		EmailUsers:         []*User{orgMemberTest1.User},
	...
	ncEmailTest, ncEmailTestCleanup := createProjectNotificationConfiguration(t, client, pTest, emailOptions)
	t.Cleanup(ncEmailTestCleanup)
...
func TestNotificationConfigurationDelete_forProjects(t *testing.T) {
	t.Parallel()
	skipUnlessBeta(t)
	client := testClient(t)
	ctx := context.Background()
	...
	ncTest, _ := createProjectNotificationConfiguration(t, client, pTest, nil)
...
func TestNotificationConfigurationVerify_forProjects(t *testing.T) {
	t.Parallel()
	skipUnlessBeta(t)
	client := testClient(t)
	ctx := context.Background()
