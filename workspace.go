...
type Workspaces interface {
	...
	// DeleteTagBindings removes all tag bindings for a workspace.
	DeleteTagBindings(ctx context.Context, workspaceID string) error
}
...
func (s *workspaces) DeleteTagBindings(ctx context.Context, workspaceID string) error {
	if !validStringID(&workspaceID) {
