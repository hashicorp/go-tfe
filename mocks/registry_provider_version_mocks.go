...
func (m *MockRegistryProviderVersions) Read(ctx context.Context, versionID tfe.RegistryProviderVersionID, options *tfe.RegistryProviderVersionReadOptions) (*tfe.RegistryProviderVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Read", ctx, versionID, options)
	ret0, _ := ret[0].(*tfe.RegistryProviderVersion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRegistryProviderVersionsMockRecorder) Read(ctx, versionID, options interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Read", reflect.TypeOf((*MockRegistryProviderVersions)(nil).Read), ctx, versionID, options)
}
