...
type Organization struct {
    ...
    attributes Organization_attributesable
    // The id property
    id *string
    // The links property
    links Selfable
    // The relationships property
    relationships Organization_relationshipsable
    // The type property
    typeEscaped *Organization_type
}
...
// returns a Organization_attributesable when successful
func (m *Organization) GetAttributes()(Organization_attributesable) {
    return m.attributes
}
...
func (m *Organization) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["attributes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateOrganization_attributesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAttributes(val.(Organization_attributesable))
        }
        return nil
    }
    ...
    res["relationships"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateOrganization_relationshipsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRelationships(val.(Organization_relationshipsable))
        }
        return nil
    }
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseOrganization_type)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*Organization_type))
        }
        return nil
    }
    return res
...
func (m *Organization) GetLinks()(Selfable) {
    return m.links
}
// GetRelationships gets the relationships property value. The relationships property
// returns a Organization_relationshipsable when successful
func (m *Organization) GetRelationships()(Organization_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *Organization_type when successful
func (m *Organization) GetTypeEscaped()(*Organization_type) {
...
func (m *Organization) SetAttributes(value Organization_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *Organization) SetId(value *string)() {
    m.id = value
}
// SetLinks sets the links property value. The links property
func (m *Organization) SetLinks(value Selfable)() {
    m.links = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *Organization) SetRelationships(value Organization_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *Organization) SetTypeEscaped(value *Organization_type)() {
    m.typeEscaped = value
}
type Organizationable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAttributes()(Organization_attributesable)
    GetId()(*string)
    GetLinks()(Selfable)
    GetRelationships()(Organization_relationshipsable)
    GetTypeEscaped()(*Organization_type)
    SetAttributes(value Organization_attributesable)()
    SetId(value *string)()
    SetLinks(value Selfable)()
    SetRelationships(value Organization_relationshipsable)()
    SetTypeEscaped(value *Organization_type)()
}
