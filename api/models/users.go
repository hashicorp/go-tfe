...
type Users struct {
    ...
    attributes Users_attributesable
    // The id property
    id *string
    // The links property
    links Selfable
    // The relationships property
    relationships Users_relationshipsable
    // The type property
    typeEscaped *Users_type
}
...
// returns a Users_attributesable when successful
func (m *Users) GetAttributes()(Users_attributesable) {
    return m.attributes
}
...
func (m *Users) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["attributes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateUsers_attributesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAttributes(val.(Users_attributesable))
        }
        return nil
    }
    ...
    res["relationships"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateUsers_relationshipsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRelationships(val.(Users_relationshipsable))
        }
        return nil
    }
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseUsers_type)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*Users_type))
        }
        return nil
    }
    return res
...
func (m *Users) GetLinks()(Selfable) {
    return m.links
}
// GetRelationships gets the relationships property value. The relationships property
// returns a Users_relationshipsable when successful
func (m *Users) GetRelationships()(Users_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *Users_type when successful
func (m *Users) GetTypeEscaped()(*Users_type) {
...
func (m *Users) SetAttributes(value Users_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *Users) SetId(value *string)() {
    m.id = value
}
// SetLinks sets the links property value. The links property
func (m *Users) SetLinks(value Selfable)() {
    m.links = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *Users) SetRelationships(value Users_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *Users) SetTypeEscaped(value *Users_type)() {
    m.typeEscaped = value
}
type Usersable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAttributes()(Users_attributesable)
    GetId()(*string)
    GetLinks()(Selfable)
    GetRelationships()(Users_relationshipsable)
    GetTypeEscaped()(*Users_type)
    SetAttributes(value Users_attributesable)()
    SetId(value *string)()
    SetLinks(value Selfable)()
    SetRelationships(value Users_relationshipsable)()
    SetTypeEscaped(value *Users_type)()
}
