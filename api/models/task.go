...
type Task struct {
    ...
    attributes Task_attributesable
    // The id property
    id *string
    // The links property
    links Selfable
    // The relationships property
    relationships Task_relationshipsable
    // The type property
    typeEscaped *Task_type
}
...
func (m *Task) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAttributes gets the attributes property value. The attributes property
// returns a Task_attributesable when successful
func (m *Task) GetAttributes()(Task_attributesable) {
    return m.attributes
}
...
func (m *Task) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["attributes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateTask_attributesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAttributes(val.(Task_attributesable))
        }
        return nil
    }
    ...
    res["relationships"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateTask_relationshipsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRelationships(val.(Task_relationshipsable))
        }
        return nil
    }
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseTask_type)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*Task_type))
        }
        return nil
    }
    return res
...
func (m *Task) GetLinks()(Selfable) {
    return m.links
}
// GetRelationships gets the relationships property value. The relationships property
// returns a Task_relationshipsable when successful
func (m *Task) GetRelationships()(Task_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *Task_type when successful
func (m *Task) GetTypeEscaped()(*Task_type) {
...
func (m *Task) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAttributes sets the attributes property value. The attributes property
func (m *Task) SetAttributes(value Task_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *Task) SetId(value *string)() {
    m.id = value
}
// SetLinks sets the links property value. The links property
func (m *Task) SetLinks(value Selfable)() {
    m.links = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *Task) SetRelationships(value Task_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *Task) SetTypeEscaped(value *Task_type)() {
    m.typeEscaped = value
}
type Taskable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAttributes()(Task_attributesable)
    GetId()(*string)
    GetLinks()(Selfable)
    GetRelationships()(Task_relationshipsable)
    GetTypeEscaped()(*Task_type)
    SetAttributes(value Task_attributesable)()
    SetId(value *string)()
    SetLinks(value Selfable)()
    SetRelationships(value Task_relationshipsable)()
    SetTypeEscaped(value *Task_type)()
}
