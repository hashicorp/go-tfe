...
type PlanExports_relationships struct {
...
func NewPlanExports_relationships()(*PlanExports_relationships) {
    m := &PlanExports_relationships{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreatePlanExports_relationshipsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreatePlanExports_relationshipsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewPlanExports_relationships(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *PlanExports_relationships) GetAdditionalData()(map[string]any) {
...
func (m *PlanExports_relationships) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *PlanExports_relationships) SetAdditionalData(value map[string]any)() {
