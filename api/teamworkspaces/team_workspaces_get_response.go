...
type TeamWorkspacesGetResponse struct {
    ...
    // The data property
    data []ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable
    // The links property
    links ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable
    // The meta property
    meta TeamWorkspacesGetResponse_metaable
}
...
func NewTeamWorkspacesGetResponse()(*TeamWorkspacesGetResponse) {
    m := &TeamWorkspacesGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateTeamWorkspacesGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateTeamWorkspacesGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewTeamWorkspacesGetResponse(), nil
}
...
// returns a []TeamWorkspacesable when successful
func (m *TeamWorkspacesGetResponse) GetData()([]ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable) {
    return m.data
}
...
func (m *TeamWorkspacesGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["data"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.CreateTeamWorkspacesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable)
                }
            }
            m.SetData(res)
        }
    ...
    res["meta"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateTeamWorkspacesGetResponse_metaFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMeta(val.(TeamWorkspacesGetResponse_metaable))
        }
        return nil
    }
    return res
...
func (m *TeamWorkspacesGetResponse) GetLinks()(ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable) {
    return m.links
}
// GetMeta gets the meta property value. The meta property
// returns a TeamWorkspacesGetResponse_metaable when successful
...
func (m *TeamWorkspacesGetResponse) SetData(value []ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable)() {
    m.data = value
}
// SetLinks sets the links property value. The links property
func (m *TeamWorkspacesGetResponse) SetLinks(value ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable)() {
    m.links = value
}
...
type TeamWorkspacesGetResponseable interface {
    ...
    GetData()([]ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable)
    ...
    SetData(value []ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamWorkspacesable)()
