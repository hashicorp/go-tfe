...
// TeamProjectsRequestBuilderGetRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type TeamProjectsRequestBuilderGetRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
    // Request query parameters
    QueryParameters *TeamProjectsRequestBuilderGetQueryParameters
}
// TeamProjectsRequestBuilderPostRequestConfiguration configuration for the request such as headers, query parameters, and middleware options.
type TeamProjectsRequestBuilderPostRequestConfiguration struct {
    // Request headers
    Headers *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestHeaders
    // Request options
    Options []i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestOption
...
// Deprecated: This method is obsolete. Use GetAsTeamProjectsGetResponse instead.
// returns a TeamProjectsResponseable when successful
// returns a Errors error when the service returns a 404 status code
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *TeamProjectsRequestBuilder) Get(ctx context.Context, requestConfiguration *TeamProjectsRequestBuilderGetRequestConfiguration)(TeamProjectsResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateTeamProjectsResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(TeamProjectsResponseable), nil
}
// GetAsTeamProjectsGetResponse list all team access grants for a project.
// returns a TeamProjectsGetResponseable when successful
// returns a Errors error when the service returns a 404 status code
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *TeamProjectsRequestBuilder) GetAsTeamProjectsGetResponse(ctx context.Context, requestConfiguration *TeamProjectsRequestBuilderGetRequestConfiguration)(TeamProjectsGetResponseable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
...
// Deprecated: This method is obsolete. Use PostAsTeamProjectsPostResponse instead.
// returns a TeamProjectsResponseable when successful
// returns a Errors error when the service returns a 404 status code
// returns a Errors error when the service returns a 422 status code
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *TeamProjectsRequestBuilder) Post(ctx context.Context, body ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamProjectable, requestConfiguration *TeamProjectsRequestBuilderPostRequestConfiguration)(TeamProjectsResponseable, error) {
...
// PostAsTeamProjectsPostResponse add a team's access to a project.
// returns a TeamProjectsPostResponseable when successful
// returns a Errors error when the service returns a 404 status code
// returns a Errors error when the service returns a 422 status code
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *TeamProjectsRequestBuilder) PostAsTeamProjectsPostResponse(ctx context.Context, body ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamProjectable, requestConfiguration *TeamProjectsRequestBuilderPostRequestConfiguration)(TeamProjectsPostResponseable, error) {
    requestInfo, err := m.ToPostRequestInformation(ctx, body, requestConfiguration);
    if err != nil {
        return nil, err
    }
...
func (m *TeamProjectsRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *TeamProjectsRequestBuilderGetRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
...
// returns a *RequestInformation when successful
func (m *TeamProjectsRequestBuilder) ToPostRequestInformation(ctx context.Context, body ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.TeamProjectable, requestConfiguration *TeamProjectsRequestBuilderPostRequestConfiguration)(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
