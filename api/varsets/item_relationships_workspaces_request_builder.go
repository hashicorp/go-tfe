...
func NewItemRelationshipsWorkspacesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRelationshipsWorkspacesRequestBuilder) {
    m := &ItemRelationshipsWorkspacesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/varsets/{varset_id}/relationships/workspaces", pathParameters),
    }
    return m
}
...
// Delete remove a variable set from one or more workspaces.
...
// Post apply a variable set to one or more workspaces.
// returns a Errors error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation remove a variable set from one or more workspaces.
...
// ToPostRequestInformation apply a variable set to one or more workspaces.
// returns a *RequestInformation when successful
