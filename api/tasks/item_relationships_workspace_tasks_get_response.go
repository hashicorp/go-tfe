...
type ItemRelationshipsWorkspaceTasksGetResponse struct {
    ...
    // The meta property
    meta ItemRelationshipsWorkspaceTasksGetResponse_metaable
}
...
func NewItemRelationshipsWorkspaceTasksGetResponse()(*ItemRelationshipsWorkspaceTasksGetResponse) {
    m := &ItemRelationshipsWorkspaceTasksGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemRelationshipsWorkspaceTasksGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateItemRelationshipsWorkspaceTasksGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemRelationshipsWorkspaceTasksGetResponse(), nil
}
...
func (m *ItemRelationshipsWorkspaceTasksGetResponse) GetData()([]ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.WorkspaceTaskable) {
    return m.data
}
...
func (m *ItemRelationshipsWorkspaceTasksGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["meta"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemRelationshipsWorkspaceTasksGetResponse_metaFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMeta(val.(ItemRelationshipsWorkspaceTasksGetResponse_metaable))
        }
        return nil
    }
    return res
...
func (m *ItemRelationshipsWorkspaceTasksGetResponse) GetLinks()(ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable) {
    return m.links
}
// GetMeta gets the meta property value. The meta property
// returns a ItemRelationshipsWorkspaceTasksGetResponse_metaable when successful
...
func (m *ItemRelationshipsWorkspaceTasksGetResponse) SetData(value []ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.WorkspaceTaskable)() {
    m.data = value
}
// SetLinks sets the links property value. The links property
func (m *ItemRelationshipsWorkspaceTasksGetResponse) SetLinks(value ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable)() {
    m.links = value
}
