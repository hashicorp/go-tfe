...
type ItemReposGetResponse struct {
    ...
    // The meta property
    meta ItemReposGetResponse_metaable
}
...
func NewItemReposGetResponse()(*ItemReposGetResponse) {
    m := &ItemReposGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemReposGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateItemReposGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemReposGetResponse(), nil
}
...
func (m *ItemReposGetResponse) GetData()([]ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.GithubAppReposable) {
    return m.data
}
...
func (m *ItemReposGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["meta"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemReposGetResponse_metaFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMeta(val.(ItemReposGetResponse_metaable))
        }
        return nil
    }
    return res
...
func (m *ItemReposGetResponse) GetLinks()(ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable) {
    return m.links
}
// GetMeta gets the meta property value. The meta property
// returns a ItemReposGetResponse_metaable when successful
...
func (m *ItemReposGetResponse) SetData(value []ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.GithubAppReposable)() {
    m.data = value
}
// SetLinks sets the links property value. The links property
func (m *ItemReposGetResponse) SetLinks(value ie0c034c41cc7c7bacea8ad562c1d20027757bf421f1a5ace132a302c2bb1878f.SelfWithPaginationable)() {
    m.links = value
}
