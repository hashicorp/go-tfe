...
// returns a ItemReposResponseable when successful
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *ItemReposRequestBuilder) Get(ctx context.Context, requestConfiguration *ItemReposRequestBuilderGetRequestConfiguration)(ItemReposResponseable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, CreateItemReposResponseFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(ItemReposResponseable), nil
}
// GetAsReposGetResponse list repositories accessible through a GitHub App installation.
// returns a ItemReposGetResponseable when successful
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *ItemReposRequestBuilder) GetAsReposGetResponse(ctx context.Context, requestConfiguration *ItemReposRequestBuilderGetRequestConfiguration)(ItemReposGetResponseable, error) {
    requestInfo, err := m.ToGetRequestInformation(ctx, requestConfiguration);
    if err != nil {
        return nil, err
    }
