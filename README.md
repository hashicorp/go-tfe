...
At this stage, most issues may be attributes to the upstream API specification. Please [create a new issue](https://github.com/hashicorp/go-tfe/issues/new?template=bug_report.md) if you observe unexpected behavior.
