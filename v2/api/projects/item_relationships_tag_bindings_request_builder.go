...
// ItemRelationshipsTagBindingsRequestBuilderGetQueryParameters list all tags associated with a project.
...
func NewItemRelationshipsTagBindingsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRelationshipsTagBindingsRequestBuilder) {
    m := &ItemRelationshipsTagBindingsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/projects/{project_id}/relationships/tag-bindings{?fields%5Btag%2Dbindings%5D}", pathParameters),
    }
    return m
}
