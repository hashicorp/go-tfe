...
// Delete remove projects from a provider set. Projects not currently assigned to the set are ignored.
...
// Post add projects to a provider set. Relationships are additive; existing project assignments are preserved.
// returns a Errors error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation remove projects from a provider set. Projects not currently assigned to the set are ignored.
...
// ToPostRequestInformation add projects to a provider set. Relationships are additive; existing project assignments are preserved.
// returns a *RequestInformation when successful
