...
// Delete remove workspaces from a provider set. Workspaces not currently assigned to the set are ignored.
...
// Post add workspaces to a provider set. Relationships are additive; existing workspace assignments are preserved.
// returns a Errors error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation remove workspaces from a provider set. Workspaces not currently assigned to the set are ignored.
...
// ToPostRequestInformation add workspaces to a provider set. Relationships are additive; existing workspace assignments are preserved.
// returns a *RequestInformation when successful
