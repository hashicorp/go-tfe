...
// ItemRelationshipsWorkspacesRequestBuilder builds and executes requests for operations under \provider-sets\{provider_set_id}\relationships\workspaces
...
func NewItemRelationshipsWorkspacesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemRelationshipsWorkspacesRequestBuilder) {
    m := &ItemRelationshipsWorkspacesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/provider-sets/{provider_set_id}/relationships/workspaces", pathParameters),
    }
    return m
}
...
// Delete remove workspaces from a provider set. Workspaces not currently assigned to the set are ignored.This operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
...
// Post add workspaces to a provider set. Relationships are additive; existing workspace assignments are preserved.This operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
// returns a Errors error when the service returns a 4XX or 5XX status code
...
// ToDeleteRequestInformation remove workspaces from a provider set. Workspaces not currently assigned to the set are ignored.This operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
...
// ToPostRequestInformation add workspaces to a provider set. Relationships are additive; existing workspace assignments are preserved.This operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
// returns a *RequestInformation when successful
