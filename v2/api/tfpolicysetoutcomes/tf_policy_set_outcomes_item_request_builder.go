...
// TfPolicySetOutcomesItemRequestBuilder builds and executes requests for operations under \tf-policy-set-outcomes\{id}
...
// NewTfPolicySetOutcomesItemRequestBuilder instantiates a new TfPolicySetOutcomesItemRequestBuilder and sets the default values.
func NewTfPolicySetOutcomesItemRequestBuilder(rawUrl string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*TfPolicySetOutcomesItemRequestBuilder) {
...
func (m *TfPolicySetOutcomesItemRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.TfPolicySetOutcomesEnvelopeable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.CreateTfPolicySetOutcomesEnvelopeFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
...
func (m *TfPolicySetOutcomesItemRequestBuilder) WithUrl(rawUrl string)(*TfPolicySetOutcomesItemRequestBuilder) {
    return NewTfPolicySetOutcomesItemRequestBuilder(rawUrl, m.BaseRequestBuilder.RequestAdapter);
}
