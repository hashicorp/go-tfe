...
// WithCidr_range_ItemRequestBuilderGetQueryParameters get details about a CIDR RangeThis operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
type WithCidr_range_ItemRequestBuilderGetQueryParameters struct {
...
func NewWithCidr_range_ItemRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*WithCidr_range_ItemRequestBuilder) {
    m := &WithCidr_range_ItemRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/cidr-ranges/{cidr_range_id}{?fields%5Bcidr%2Dranges%5D}", pathParameters),
    }
    return m
}
...
// returns a Errors error when the service returns a 4XX or 5XX status code
func (m *WithCidr_range_ItemRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[WithCidr_range_ItemRequestBuilderGetQueryParameters])(i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.CidrRangesEnvelopeable, error) {
...
// returns a *RequestInformation when successful
func (m *WithCidr_range_ItemRequestBuilder) ToGetRequestInformation(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[WithCidr_range_ItemRequestBuilderGetQueryParameters])(*i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestInformation, error) {
