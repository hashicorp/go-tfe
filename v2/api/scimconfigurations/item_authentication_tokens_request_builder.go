...
// ItemAuthenticationTokensRequestBuilder builds and executes requests for operations under \scim-configurations\{scim_configuration_id}\authentication-tokens
type ItemAuthenticationTokensRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemAuthenticationTokensRequestBuilderGetQueryParameters list all tokens for the specified SCIM configuration.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
func NewItemAuthenticationTokensRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemAuthenticationTokensRequestBuilder) {
    m := &ItemAuthenticationTokensRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/scim-configurations/{scim_configuration_id}/authentication-tokens{?page%5Bnumber%5D*,page%5Bsize%5D*}", pathParameters),
    }
    return m
}
...
// Get list all tokens for the specified SCIM configuration.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
// Post create a SCIM configuration tokenThis operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
func (m *ItemAuthenticationTokensRequestBuilder) Post(ctx context.Context, body i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.AuthenticationTokensEnvelopeable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.AuthenticationTokensEnvelopeable, error) {
    ...
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        ...
        "500": i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.CreateErrorsFromDiscriminatorValue,
        "XXX": i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.CreateErrorsFromDiscriminatorValue,
    }
...
// ToGetRequestInformation list all tokens for the specified SCIM configuration.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
// ToPostRequestInformation create a SCIM configuration tokenThis operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
// returns a *RequestInformation when successful
