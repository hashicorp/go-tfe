...
// ItemNotificationConfigurationsRequestBuilder builds and executes requests for operations under \stacks\{stack_id}\notification-configurations
...
func NewItemNotificationConfigurationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemNotificationConfigurationsRequestBuilder) {
    m := &ItemNotificationConfigurationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/stacks/{stack_id}/notification-configurations", pathParameters),
    }
    return m
}
...
// Get list all notification configurations for a given stack.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
// Post create a new notification configuration for a given stack.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
// ToGetRequestInformation list all notification configurations for a given stack.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
// ToPostRequestInformation create a new notification configuration for a given stack.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
// returns a *RequestInformation when successful
