...
type ItemParametersGetResponse struct {
    ...
    // The meta property
    meta ItemParametersGetResponse_metaable
}
// NewItemParametersGetResponse instantiates a new ItemParametersGetResponse and sets the default values.
func NewItemParametersGetResponse()(*ItemParametersGetResponse) {
    m := &ItemParametersGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemParametersGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemParametersGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemParametersGetResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemParametersGetResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetData gets the data property value. The data property
// returns a []Varsable when successful
func (m *ItemParametersGetResponse) GetData()([]i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.Varsable) {
    return m.data
}
...
func (m *ItemParametersGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["meta"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemParametersGetResponse_metaFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMeta(val.(ItemParametersGetResponse_metaable))
        }
        return nil
    }
    return res
...
func (m *ItemParametersGetResponse) GetLinks()(i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.SelfWithPaginationable) {
    return m.links
}
// GetMeta gets the meta property value. The meta property
// returns a ItemParametersGetResponse_metaable when successful
func (m *ItemParametersGetResponse) GetMeta()(ItemParametersGetResponse_metaable) {
    return m.meta
}
// Serialize serializes information the current object
func (m *ItemParametersGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetData() != nil {
...
func (m *ItemParametersGetResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetData sets the data property value. The data property
func (m *ItemParametersGetResponse) SetData(value []i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.Varsable)() {
    m.data = value
}
// SetLinks sets the links property value. The links property
func (m *ItemParametersGetResponse) SetLinks(value i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.SelfWithPaginationable)() {
    m.links = value
}
// SetMeta sets the meta property value. The meta property
func (m *ItemParametersGetResponse) SetMeta(value ItemParametersGetResponse_metaable)() {
    m.meta = value
}
