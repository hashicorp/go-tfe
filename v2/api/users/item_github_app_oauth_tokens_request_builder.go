...
type ItemGithubAppOauthTokensRequestBuilderGetQueryParameters struct {
    // Return only the specified fields for github-app-oauth-tokens resource(s) in the response. Use underscores for identifiers that contain a dash: For example, auto_apply instead of auto-apply. An empty value indicates that no fields should be returned.
    FieldsgithubAppOauthTokens []string "uriparametername:\"fields%5Bgithub%2Dapp%2Doauth%2Dtokens%5D\""
...
func NewItemGithubAppOauthTokensRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGithubAppOauthTokensRequestBuilder) {
    m := &ItemGithubAppOauthTokensRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/users/{user_id}/github-app-oauth-tokens{?fields%5Bgithub%2Dapp%2Doauth%2Dtokens%5D,page%5Bnumber%5D*,page%5Bsize%5D*}", pathParameters),
    }
    return m
}
