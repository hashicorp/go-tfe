...
func CreateItemStacksGetResponse_StacksFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemStacksGetResponse_Stacks(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemStacksGetResponse_Stacks) GetAdditionalData()(map[string]any) {
...
func (m *ItemStacksGetResponse_Stacks) GetAttributes()(Stacks_attributesable) {
    return m.attributes
}
...
func (m *ItemStacksGetResponse_Stacks) GetId()(*string) {
    return m.id
}
// GetLinks gets the links property value. The links property
// returns a Stacks_linksable when successful
func (m *ItemStacksGetResponse_Stacks) GetLinks()(Stacks_linksable) {
    return m.links
}
...
func (m *ItemStacksGetResponse_Stacks) GetRelationships()(Stacks_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *Stacks_type when successful
func (m *ItemStacksGetResponse_Stacks) GetTypeEscaped()(*Stacks_type) {
...
func (m *ItemStacksGetResponse_Stacks) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAttributes sets the attributes property value. The attributes property
func (m *ItemStacksGetResponse_Stacks) SetAttributes(value Stacks_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *ItemStacksGetResponse_Stacks) SetId(value *string)() {
    m.id = value
}
// SetLinks sets the links property value. The links property
func (m *ItemStacksGetResponse_Stacks) SetLinks(value Stacks_linksable)() {
    m.links = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *ItemStacksGetResponse_Stacks) SetRelationships(value Stacks_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *ItemStacksGetResponse_Stacks) SetTypeEscaped(value *Stacks_type)() {
    m.typeEscaped = value
}
