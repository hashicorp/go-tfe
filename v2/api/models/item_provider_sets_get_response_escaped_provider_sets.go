...
func CreateItemProviderSetsGetResponse_ProviderSetsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemProviderSetsGetResponse_ProviderSets(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemProviderSetsGetResponse_ProviderSets) GetAdditionalData()(map[string]any) {
...
func (m *ItemProviderSetsGetResponse_ProviderSets) GetAttributes()(ProviderSets_attributesable) {
    return m.attributes
}
...
func (m *ItemProviderSetsGetResponse_ProviderSets) GetId()(*string) {
    return m.id
}
...
func (m *ItemProviderSetsGetResponse_ProviderSets) GetRelationships()(ProviderSets_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *ProviderSets_type when successful
func (m *ItemProviderSetsGetResponse_ProviderSets) GetTypeEscaped()(*ProviderSets_type) {
...
func (m *ItemProviderSetsGetResponse_ProviderSets) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAttributes sets the attributes property value. The attributes property
func (m *ItemProviderSetsGetResponse_ProviderSets) SetAttributes(value ProviderSets_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *ItemProviderSetsGetResponse_ProviderSets) SetId(value *string)() {
    m.id = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *ItemProviderSetsGetResponse_ProviderSets) SetRelationships(value ProviderSets_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *ItemProviderSetsGetResponse_ProviderSets) SetTypeEscaped(value *ProviderSets_type)() {
    m.typeEscaped = value
}
