...
func CreateItemWorkspacesGetResponse_WorkspacesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemWorkspacesGetResponse_Workspaces(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemWorkspacesGetResponse_Workspaces) GetAdditionalData()(map[string]any) {
...
func (m *ItemWorkspacesGetResponse_Workspaces) GetAttributes()(Workspaces_attributesable) {
    return m.attributes
}
...
func (m *ItemWorkspacesGetResponse_Workspaces) GetId()(*string) {
    return m.id
}
// GetLinks gets the links property value. The links property
// returns a WorkspaceLinksable when successful
func (m *ItemWorkspacesGetResponse_Workspaces) GetLinks()(WorkspaceLinksable) {
    return m.links
}
...
func (m *ItemWorkspacesGetResponse_Workspaces) GetRelationships()(Workspaces_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *Workspaces_type when successful
func (m *ItemWorkspacesGetResponse_Workspaces) GetTypeEscaped()(*Workspaces_type) {
...
func (m *ItemWorkspacesGetResponse_Workspaces) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAttributes sets the attributes property value. The attributes property
func (m *ItemWorkspacesGetResponse_Workspaces) SetAttributes(value Workspaces_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *ItemWorkspacesGetResponse_Workspaces) SetId(value *string)() {
    m.id = value
}
// SetLinks sets the links property value. The links property
func (m *ItemWorkspacesGetResponse_Workspaces) SetLinks(value WorkspaceLinksable)() {
    m.links = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *ItemWorkspacesGetResponse_Workspaces) SetRelationships(value Workspaces_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *ItemWorkspacesGetResponse_Workspaces) SetTypeEscaped(value *Workspaces_type)() {
    m.typeEscaped = value
}
