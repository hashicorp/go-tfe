...
func NewRegistryModules_attributes_versionStatuses()(*RegistryModules_attributes_versionStatuses) {
    m := &RegistryModules_attributes_versionStatuses{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateRegistryModules_attributes_versionStatusesFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateRegistryModules_attributes_versionStatusesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewRegistryModules_attributes_versionStatuses(), nil
}
