...
type ItemTasksGetResponse_Tasks struct {
    ...
    attributes Tasks_attributesable
    // The id property
    id *string
    // The links property
    links Selfable
    // The relationships property
    relationships Tasks_relationshipsable
    // The type property
    typeEscaped *Tasks_type
}
...
func CreateItemTasksGetResponse_TasksFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemTasksGetResponse_Tasks(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemTasksGetResponse_Tasks) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAttributes gets the attributes property value. The attributes property
// returns a Tasks_attributesable when successful
func (m *ItemTasksGetResponse_Tasks) GetAttributes()(Tasks_attributesable) {
    return m.attributes
}
...
func (m *ItemTasksGetResponse_Tasks) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["attributes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateTasks_attributesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAttributes(val.(Tasks_attributesable))
        }
        return nil
    }
    ...
    res["relationships"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateTasks_relationshipsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRelationships(val.(Tasks_relationshipsable))
        }
        return nil
    }
    res["type"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseTasks_type)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetTypeEscaped(val.(*Tasks_type))
        }
        return nil
    }
    return res
...
func (m *ItemTasksGetResponse_Tasks) GetId()(*string) {
    return m.id
}
// GetLinks gets the links property value. The links property
// returns a Selfable when successful
func (m *ItemTasksGetResponse_Tasks) GetLinks()(Selfable) {
    return m.links
}
// GetRelationships gets the relationships property value. The relationships property
// returns a Tasks_relationshipsable when successful
func (m *ItemTasksGetResponse_Tasks) GetRelationships()(Tasks_relationshipsable) {
    return m.relationships
}
// GetTypeEscaped gets the type property value. The type property
// returns a *Tasks_type when successful
func (m *ItemTasksGetResponse_Tasks) GetTypeEscaped()(*Tasks_type) {
...
func (m *ItemTasksGetResponse_Tasks) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAttributes sets the attributes property value. The attributes property
func (m *ItemTasksGetResponse_Tasks) SetAttributes(value Tasks_attributesable)() {
    m.attributes = value
}
// SetId sets the id property value. The id property
func (m *ItemTasksGetResponse_Tasks) SetId(value *string)() {
    m.id = value
}
// SetLinks sets the links property value. The links property
func (m *ItemTasksGetResponse_Tasks) SetLinks(value Selfable)() {
    m.links = value
}
// SetRelationships sets the relationships property value. The relationships property
func (m *ItemTasksGetResponse_Tasks) SetRelationships(value Tasks_relationshipsable)() {
    m.relationships = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *ItemTasksGetResponse_Tasks) SetTypeEscaped(value *Tasks_type)() {
    m.typeEscaped = value
}
