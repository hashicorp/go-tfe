...
func SerializeWorkspaces_relationships_readme_data_type(values []Workspaces_relationships_readme_data_type) []string {
...
func (i Workspaces_relationships_readme_data_type) isMultiValue() bool {
    return false
}
