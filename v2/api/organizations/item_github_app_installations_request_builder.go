...
// ItemGithubAppInstallationsRequestBuilder builds and executes requests for operations under \organizations\{name-id}\github-app-installations
...
// ByGithub_app_installation_id gets an item from the github.com/hashicorp/go-tfe/v2/api.organizations.item.githubAppInstallations.item collection
...
func NewItemGithubAppInstallationsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemGithubAppInstallationsRequestBuilder) {
    m := &ItemGithubAppInstallationsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/organizations/{name%2Did}/github-app-installations{?page%5Bnumber%5D*,page%5Bsize%5D*}", pathParameters),
    }
    return m
}
