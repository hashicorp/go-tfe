...
// ItemWorkspacesItemActionsSafeDeleteRequestBuilder builds and executes requests for operations under \organizations\{name-id}\workspaces\{workspace_name}\actions\safe-delete
...
func NewItemWorkspacesItemActionsSafeDeleteRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemWorkspacesItemActionsSafeDeleteRequestBuilder) {
    m := &ItemWorkspacesItemActionsSafeDeleteRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/organizations/{name%2Did}/workspaces/{workspace_name}/actions/safe-delete", pathParameters),
    }
    return m
}
