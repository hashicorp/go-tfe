...
type ItemRelationshipsModuleProducersGetResponse struct {
    ...
    // The meta property
    meta ItemRelationshipsModuleProducersGetResponse_metaable
}
// NewItemRelationshipsModuleProducersGetResponse instantiates a new ItemRelationshipsModuleProducersGetResponse and sets the default values.
func NewItemRelationshipsModuleProducersGetResponse()(*ItemRelationshipsModuleProducersGetResponse) {
    m := &ItemRelationshipsModuleProducersGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateItemRelationshipsModuleProducersGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateItemRelationshipsModuleProducersGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewItemRelationshipsModuleProducersGetResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *ItemRelationshipsModuleProducersGetResponse) GetAdditionalData()(map[string]any) {
...
func (m *ItemRelationshipsModuleProducersGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["meta"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateItemRelationshipsModuleProducersGetResponse_metaFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetMeta(val.(ItemRelationshipsModuleProducersGetResponse_metaable))
        }
        return nil
    }
    return res
...
func (m *ItemRelationshipsModuleProducersGetResponse) GetLinks()(i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.SelfWithPaginationable) {
    return m.links
}
// GetMeta gets the meta property value. The meta property
// returns a ItemRelationshipsModuleProducersGetResponse_metaable when successful
func (m *ItemRelationshipsModuleProducersGetResponse) GetMeta()(ItemRelationshipsModuleProducersGetResponse_metaable) {
    return m.meta
}
// Serialize serializes information the current object
func (m *ItemRelationshipsModuleProducersGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetData() != nil {
...
func (m *ItemRelationshipsModuleProducersGetResponse) SetAdditionalData(value map[string]any)() {
...
func (m *ItemRelationshipsModuleProducersGetResponse) SetLinks(value i05d5aa6b14db285c2e8df48c915f7a7082b77b17cca0def522e18528f80bec16.SelfWithPaginationable)() {
    m.links = value
}
// SetMeta sets the meta property value. The meta property
func (m *ItemRelationshipsModuleProducersGetResponse) SetMeta(value ItemRelationshipsModuleProducersGetResponse_metaable)() {
    m.meta = value
}
