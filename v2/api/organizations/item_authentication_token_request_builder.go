...
type ItemAuthenticationTokenRequestBuilderDeleteQueryParameters struct {
    // The type of organization token to delete. Omit for the default organization token.
...
type ItemAuthenticationTokenRequestBuilderPostQueryParameters struct {
    // The type of organization token to create. Omit for the default organization token.
