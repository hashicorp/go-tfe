...
// EntitlementSet the entitlementSet property
// returns a *ItemEntitlementSetRequestBuilder when successful
func (m *NameItemRequestBuilder) EntitlementSet()(*ItemEntitlementSetRequestBuilder) {
    return NewItemEntitlementSetRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
