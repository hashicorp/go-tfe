...
// ItemPolicySetsRequestBuilder builds and executes requests for operations under \organizations\{name-id}\policy-sets
...
func NewItemPolicySetsRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemPolicySetsRequestBuilder) {
    m := &ItemPolicySetsRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/organizations/{name%2Did}/policy-sets{?filter%5Bkind%5D*,filter%5Bversioned%5D*,page%5Bnumber%5D*,page%5Bsize%5D*,search%5Bname%5D*}", pathParameters),
    }
    return m
}
