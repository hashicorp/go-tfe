...
import (
    ...
    i0711e4d745f67ead2258249f2ad6fa4e6ada44718b0fbd8afbb5d8a4ce88b276 "github.com/hashicorp/go-tfe/v2/api/stackdeploymentgroups/item/cancel"
)

// ItemCancelRequestBuilder builds and executes requests for operations under \stack-deployment-groups\{stack_deployment_group_id}\cancel
...
func NewItemCancelRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemCancelRequestBuilder) {
    m := &ItemCancelRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/stack-deployment-groups/{stack_deployment_group_id}/cancel", pathParameters),
    }
    return m
}
...
// Post cancel all non-terminal runs in a stack deployment group and move the group to a failed state.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
...
func (m *ItemCancelRequestBuilder) Post(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(*i0711e4d745f67ead2258249f2ad6fa4e6ada44718b0fbd8afbb5d8a4ce88b276.CancelPostResponse, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendEnum(ctx, requestInfo, i0711e4d745f67ead2258249f2ad6fa4e6ada44718b0fbd8afbb5d8a4ce88b276.ParseCancelPostResponse, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(*i0711e4d745f67ead2258249f2ad6fa4e6ada44718b0fbd8afbb5d8a4ce88b276.CancelPostResponse), nil
}
// ToPostRequestInformation cancel all non-terminal runs in a stack deployment group and move the group to a failed state.This operation is considered INTERNAL BETA, is unavailable to most users, and should not be shared in public channels.
