...
// ItemActionsOverrideRequestBuilder builds and executes requests for operations under \tf-policy-evaluations\{-id}\actions\override
...
func NewItemActionsOverrideRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemActionsOverrideRequestBuilder) {
    m := &ItemActionsOverrideRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/tf-policy-evaluations/{%2Did}/actions/override", pathParameters),
    }
    return m
}
...
// Post override a mandatory-overridable Terraform Policy evaluation to allow the run to continue.This operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
...
// ToPostRequestInformation override a mandatory-overridable Terraform Policy evaluation to allow the run to continue.This operation is considered BETA, is SUBJECT TO CHANGE, and may be unavailable to some users.
